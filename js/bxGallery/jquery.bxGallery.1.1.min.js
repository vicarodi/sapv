...
function set_main_img(){$orig.find('img').each(function(){var $this=$(this);var $imgheight=$this.height();var $imgwidth=$this.width();if($this.attr('title')!=''){caption='';/*$this.parent().append('<div class="caption">'+caption+'</div>');*/}
