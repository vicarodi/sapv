...
switch ($_GET['accion']){
    ...
    if($_POST['id_propietario']=='OTRO'){
       ...
       $idPropietario= $_POST['id_propietario'];
        ...
        mysql_query("Insert into propiedades (id_propietario,id_tipo_propiedad,direccion,ciudad,estado,codigo_postal,id_pais,habitaciones,banos,gps) 
        values ('".$idPropietario."','".$_POST['id_propiedad']."','".$_POST['direccion']."','".$_POST['ciudad']."','".$_POST['estado']."','".$_POST['codigo_postal']."','".$_POST['pais']."','".$_POST['habitaciones']."','".$_POST['banos']."','".$_POST['coordenadas']."')")or die(mysql_error());
	...
	case "modificar":
	   ...
	   //Cambiar la palabra propiedades por el nombre de la tabla, y los nombres de los campos en la BD que les toco a uds
        ...
        gps='".$_POST['coordenadas']."' where id='".$_POST['id']."'")or die(mysql_error());
        ...
        <table>
            <tr>
                <td align="center" width="150px">
                    <?
                        $queryRandom=mysql_fetch_assoc(mysql_query("select * from propiedad_imagenes where id_propiedad='".$registro['idPropiedad']."' order by RAND()"));
