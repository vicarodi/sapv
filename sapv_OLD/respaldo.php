...
<fieldset style="width:70%">
	<legend style="font-weight:bold; font-family:Tahoma; font-size:14px">Respaldo de la Base de Datos </legend>
...
<center>
<div id="dialog4" style="display: none;">Esta ud seguro de respaldar la Base de datos?</div>
<table cellspacing="0" cellpadding="0" border="0" >
    
     
    </tr> <td width="455" align="center"><font color="">&nbsp;&nbsp;&nbsp;&nbsp;<b>Crea una copia de seguridad
              de la base de datos "Hmedicas".</b></font></td>
  <tr align="center">

      <td height="150" align="center" valign="middle" background=""><BR>
       
<form action="index2.php?doc=respaldo" method="post" id="Formulario" name="Formulario" >
  <?creador_boton('button','Respaldar','respaldo','onclick="Confirmacion()"')?>
  <input class="hidden" type="hidden" name="respaldo" value="&nbsp;Respaldar&nbsp;">
</form>
            <br>
  </table>
